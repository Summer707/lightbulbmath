    ...
    <section className="relative overflow-hidden border-b bg-gradient-to-b from-amber-50 to-white">
      <div className="mx-auto max-w-6xl px-6 py-16 grid md:grid-cols-2 gap-8 items-center">
        ...
        <div className="relative">
          <Image src="/hero.jpg" alt="Lightbulb" width={800} height={600} className="rounded-xl shadow" />
          <Image src="/logo.svg" alt="Logo" width={80} height={80} className="absolute -bottom-6 -right-6 opacity-90" />
        </div>
      </div>
    </section>
  );
